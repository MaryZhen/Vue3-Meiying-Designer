...
// 获取字体
export const getFonts = (params: Type.Object = {}) => fetch('https://palxp.cn:8887/design/fonts', params)
// export const getFontSub = (params: Type.Object = {}, extra: any = {}) => fetch('https://palxp.cn:8887/design/font_sub', params, 'get', {}, extra)
