    ...
    <div class="top-nav">
      <div class="top-nav-wrap">
        ...
        <div style="flex: 1">
          ...
          <el-button plain type="primary" @click="returnHome">首页</el-button>
        </div>
  ...
  setup() {
    ...
    async function loadPSD(file: any) {
      ...
      setTimeout(async () => {
        ...
        store.commit('setDPage', {page: Object.assign(store.getters.dPage, { width, height, backgroundColor: bg.color, backgroundImage: bg.image })})
    ...
    async function clear() {
      ...
      store.commit('setDPage', {page: Object.assign(store.getters.dPage, { width: 960, height: 1200, backgroundColor: '#ffffff', backgroundImage: '' })})
